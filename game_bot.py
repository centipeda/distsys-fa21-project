...
class GameClient:
    ...
    def __init__(self, server_host=SERVER_HOST, server_port=SERVER_PORT, display=True, extra_latency=0):
        ...
        # self.connect_server()
        self.bot_step = 0 # FOR TESTING PURPOSES
    ...
    def process_input(self):
        ...
        """EDITED TO MAKE A BOT THAT GOES IN CIRCLES AND SHOOTS PROJECTILES"""
        true_bot_step = self.bot_step%4
